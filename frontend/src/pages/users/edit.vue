                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrluser_id" v-model.trim="formData.user_id"  :label="$t('userId')" type="text" :placeholder="$t('enterUserId')"      
...
<script setup>
	...
	const formDefaultValues = Object.assign({
		user_id: "", username: "", bio: "", tele: "", photo: "", user_role_id: "", followers_count: "0", following_count: "0", 
	}, props.pageData);
