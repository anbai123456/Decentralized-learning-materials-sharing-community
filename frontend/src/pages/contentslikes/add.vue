                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <api-data-source :enable-cache="true"   api-path="components_data/content_id_option_list_2" >
                                                        <template v-slot="req">
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'contentslikesadd',
		},
		apiPath : {
			type : String,
			default : 'contentslikes/add',
		},
		submitButtonLabel: {
			type: String,
			default: () => $t('submit'),
	...
	onMounted(()=>{
		const pageTitle = $t('addNewContentsLike');
