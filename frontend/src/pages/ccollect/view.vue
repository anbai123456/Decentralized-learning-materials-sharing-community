...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'ccollectview',
		},
		apiPath: {
			type: String,
			default: 'ccollect/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: () => $t('edit'),
			command: (event) => { app.openPageDialog({ page:'ccollect/edit', url: `/ccollect/edit/${data.collect_id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = $t('cCollectDetails');
