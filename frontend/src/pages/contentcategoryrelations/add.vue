                        ...
                        <div class="grid justify-content-between align-items-center">
                            ...
                            <div  class="col " >
                                <div class=" text-2xl text-primary font-bold" >
                                    {{ $t('addNewContentCategoryRelation') }}
                                </div>
                            </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'contentcategoryrelationsadd',
		},
		apiPath : {
			type : String,
			default : 'contentcategoryrelations/add',
		},
		submitButtonLabel: {
			type: String,
			default: () => $t('submit'),
	...
	function afterSubmit(response) { 
		...
		if(app.isDialogOpen()){
			...
			app.navigateTo(`/contentcategoryrelations`);
		}
	}
	...
	onMounted(()=>{
		const pageTitle = $t('addNewContentCategoryRelation');
