                                    ...
                                    <div class="grid">
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <api-data-source :enable-cache="true"   api-path="components_data/group_id_option_list" >
                                                        <template v-slot="req">
                                                            <Dropdown  class="w-full" :class="getErrorClass('group_id')"   :loading="req.loading"   optionLabel="label" optionValue="value" ref="ctrlgroup_id"  v-model="formData.group_id" :options="req.response" :label="$t('groupId')"  :placeholder="$t('selectAValue')" >
                                                            </Dropdown> 
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <Dropdown  class="w-full" :class="getErrorClass('role')"      optionLabel="label" optionValue="value" ref="ctrlrole"  v-model="formData.role" :options="app.menus.role" :label="$t('role')"  :placeholder="$t('selectAValue')" >
                                                    </Dropdown> 
...
<script setup>
	...
	const props = defineProps({
		...
		routeName : {
			type : String,
			default : 'groupmembersadd',
		},
		apiPath : {
			type : String,
			default : 'groupmembers/add',
		},
		submitButtonLabel: {
			type: String,
			default: () => $t('submit'),
	...
	onMounted(()=>{
		const pageTitle = $t('addNewGroupMember');
