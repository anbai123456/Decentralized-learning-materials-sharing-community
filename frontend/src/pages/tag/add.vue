                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrltag" v-model.trim="formData.tag"  :label="$t('tag')" type="text" :placeholder="$t('enterTag')"      
                                                    class=" w-full" :class="getErrorClass('tag')">
                                                    </InputText>
