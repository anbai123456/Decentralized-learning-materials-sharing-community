                        ...
                        <div  class="sm:col-6 comp-grid" >
                            <div class="">
                                <div class="card my-3 p-3 surface-50">
                                    <NotificationLoginpagelistPage ref="notificationListPage"  :limit="10" :show-header="true" :show-breadcrumbs="true" :show-footer="true" :paginate="true" page-store-key="INDEX-NOTIFICATION-LOGINPAGELIST" is-sub-page>
                                    </NotificationLoginpagelistPage>
                                </div>
                            </div>
                        </div>
                    </div>
...
<script setup>
	...
	import NotificationLoginpagelistPage from "../notification/loginpagelist.vue";
