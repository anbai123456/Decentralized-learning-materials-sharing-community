                                    ...
                                    <div class="col">
                                        <div class="mb-3 grid ">
                                            ...
                                            <div class="col-12 md:col-4">
                                                <div class="flex gap-2 align-items-center card shadow-none p-3 surface-100 ">
                                                    <div class="">
                                                        <div class="text-400 mb-1">{{ $t('replyMultimedia') }}</div>
                                                        <div class="font-bold">{{ item.reply_multimedia }}</div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'multimediareplyview',
		},
		apiPath: {
			type: String,
			default: 'multimediareply/view',
		},
		autoLoad: {
			type: Boolean,
			default: true,
	...
	function getActionMenuModel(data){
		...
		{
			label: () => $t('edit'),
			command: (event) => { app.openPageDialog({ page:'multimediareply/edit', url: `/multimediareply/edit/${data.reply_id}`, closeBtn: true }) },
			icon: "pi pi-pencil",
	...
	onMounted(()=>{ 
		const pageTitle = $t('multimediaReplyDetails');
