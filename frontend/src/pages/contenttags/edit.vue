                                            ...
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <api-data-source :enable-cache="true"   api-path="components_data/tag_id_option_list" >
                                                        <template v-slot="req">
                                                            <Dropdown  class="w-full" :class="getErrorClass('tag_id')"   :loading="req.loading"   optionLabel="label" optionValue="value" ref="ctrltag_id"  v-model="formData.tag_id" :options="req.response" :label="$t('tagId')"  :placeholder="$t('selectAValue')" >
                                                            </Dropdown> 
...
<script setup>
	...
	const props = defineProps({
		...
		routeName: {
			type: String,
			default: 'contenttagsedit',
		},
		pagePath: {
			type : String,
			default : 'contenttags/edit',
		},
		apiPath: {
			type: String,
			default: 'contenttags/edit',
	...
	onMounted(()=>{
		const pageTitle = $t('editContentTag');
