                                    ...
                                    <div class="grid">
                                        ...
                                        <div class="col-12">
                                            <div class="formgrid grid">
                                                ...
                                                <div class="col-12 md:col-9">
                                                    <InputText  ref="ctrlliked_count" v-model.trim="formData.liked_count"  :label="$t('likedCount')" type="number" :placeholder="$t('enterLikedCount')"   step="any"    
                                                    class=" w-full" :class="getErrorClass('liked_count')">
                                                    </InputText>
                                                    <small v-if="isFieldValid('liked_count')" class="p-error">{{ getFieldError('liked_count') }}</small> 
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<script setup>
	...
	const formDefaultValues = Object.assign({
		user_id: "", content_id: "", liked_count: "", 
	}, props.pageData);
