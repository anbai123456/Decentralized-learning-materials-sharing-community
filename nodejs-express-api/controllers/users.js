...
router.post('/add/', 
	[
		...
		body('followers_count').not().isEmpty().isNumeric(),
		body('following_count').not().isEmpty().isNumeric(),
	], validateFormData
...
router.post('/edit/:recid', 
	[
		...
		body('followers_count').optional({nullable: true}).not().isEmpty().isNumeric(),
		body('following_count').optional({nullable: true}).not().isEmpty().isNumeric(),
	], validateFormData
, async (req, res) => {
	try{
		const recid = req.params.recid;
